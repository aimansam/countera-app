...
- [ ] Review the page at `http://localhost:3000`
...
- [x] Scaffold the Docker-first Next.js app
- [ ] Add PostgreSQL in Compose
- [x] Add `.env.example`
- [x] Add app README commands
- [x] Validate Compose config
- [ ] Push app scaffold to GitHub

## Step 5: MVP Build Start
