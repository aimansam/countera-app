export type BusinessPresetTemplate = {
  id: string;
  name: string;
  description: string;
...
export const businessPresetTemplates = [
  {
    id: "general-shop",
    name: "General Shop",
    description: "Products, customers, stock, and simple daily sales for local stores.",
    labels: {
      customer: "Customer",
      product: "Product",
      service: "Service",
  ...
  },
  {
    ...
    description: "Item catalog, inventory, discounts, and product sales reporting.",
    labels: {
      customer: "Customer",
      product: "Item",
      service: "Service",
  ...
  },
  {
    ...
    description: "Service catalog, clients, staff activity, tips, and daily totals.",
    labels: {
      customer: "Client",
      product: "Product",
      service: "Service",
  ...
  },
  {
    id: "cafe",
    name: "Cafe",
    description: "Menu items, register totals, payment mix, and fast counter orders.",
    labels: {
      customer: "Guest",
      product: "Menu item",
      service: "Service",
  ...
  },
  {
    id: "salon-barber",
    name: "Salon/Barber",
    description: "Services, retail products, staff, tips, and repeat client history.",
    labels: {
      customer: "Client",
      product: "Product",
      service: "Service",
  ...
  },
  {
    id: "repair-shop",
    name: "Repair Shop",
    description: "Repair services, parts, customer records, and stock movement.",
    labels: {
      customer: "Customer",
      product: "Part",
  ...
  },
  {
    ...
    description: "Visit checkout, patient labels, service records, and staff summaries.",
    labels: {
      customer: "Patient",
      product: "Product",
      service: "Service",
...
] satisfies BusinessPresetTemplate[];